...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
               (TO_NUMBER(B.CUSTO_REAIS)) AS CUSTO_GERENCIAL
                               , (TO_NUMBER(B.CUSTO_SERV)) AS CUSTO_SERV, (TO_NUMBER(NVL(B.CUSTO_MATERIAL,0))) AS CUSTO_MATERIAL 
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE (B.ITEM)=(C.ITEM)  AND TRIM(C.LISTA) IN ('M') AND B.DATA=C.DATA)
AND TRIM(B.LISTA)='M1'
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE (B.ITEM)=(C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1') AND B.DATA=C.DATA)
AND TRIM(B.LISTA)='M2'
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE (B.ITEM)=(C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1','M2') AND B.DATA=C.DATA)
AND TRIM(B.LISTA)='M3'
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE (B.ITEM)=(C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1','M2','M3') AND B.DATA=C.DATA)
AND TRIM(B.LISTA)='PM'
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE (B.ITEM)=(C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1','M2','M3','PM') AND B.DATA=C.DATA)
AND (B.LISTA)='AT1'
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE (B.ITEM)=(C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1','M2','M3','PM','AT1') AND B.DATA=C.DATA)
AND (B.LISTA)='AT2'       
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE  (B.ITEM)= (C.ITEM)  AND  TRIM(C.LISTA) IN ('M','M1','M2','M3','PM','AT1','AT2') AND B.DATA=C.DATA)
AND  (B.LISTA)='PA1'              
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B 
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE  (B.ITEM)= (C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1','M2','M3','PM','AT1','AT2','PA1') AND B.DATA=C.DATA)
AND  (B.LISTA)='PA2'                       
...
B.DATA DATA_G, 
  TRIM(B.ITEM) AS COD_ITEM_G,
     ...
     ,B.LISTA
FROM  PUBDB.TEMP_CUSTO_ULTMES B  
WHERE  NOT EXISTS (SELECT 1 FROM PUBDB.TEMP_CUSTO_ULTMES C  WHERE  (B.ITEM)= (C.ITEM)  AND TRIM(C.LISTA) IN ('M','M1','M2','M3','PM','AT1','AT2','PA1','PA2') AND B.DATA=C.DATA)
AND  (B.LISTA)='PA5'          
...
DISTINCT 
   ...
   CASE WHEN pjs.tipo_pedido='CV' THEN 0 ELSE NVL(C.CUSTO_MATERIAL,0) END CUSTO_MATERIAL,
